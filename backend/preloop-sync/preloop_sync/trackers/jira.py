"""
Jira tracker implementation for preloop_sync.
"""
...
from preloop_models.crud import crud_webhook, crud_organization, crud_project
from preloop_ai.schemas.tracker_models import (
    Issue,
    IssueComment,
    IssueCreate,
    IssueFilter,
...
class JiraTracker(BaseTracker):
    ...
    def register_webhook(
        ...
        try:
            ...
            if not verified:
                ...
                if not is_test_env:
                    try:
                        from preloop_sync.tasks import notify_admins
    ...
    def cleanup_stale_webhooks(self, preloop_url: str) -> Dict[str, int]:
        ...
        from preloop_models.crud import crud_webhook
