...
def notify_admins(subject: str, message: str, message_html: str = None):
    from preloop_ai.utils.email import send_email  # noqa: E402
    from preloop_ai.config import settings  # noqa: E402
