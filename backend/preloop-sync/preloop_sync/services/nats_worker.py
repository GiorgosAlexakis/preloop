...
import preloop_sync.tasks as tasks
    ...
    async def start_listening(self):
        ...
        if self.tasks_allowlist:
            for task_name in self.tasks_allowlist:
                subjects_to_subscribe.append(f"preloop_sync.tasks.{task_name}")
        else:
            subjects_to_subscribe.append("preloop_sync.tasks.*")
