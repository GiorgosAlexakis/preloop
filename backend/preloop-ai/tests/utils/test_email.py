...
class TestSendEmail:
    ...
    @patch("preloop_ai.utils.email.SMTP_PASSWORD", "password")
    @patch("preloop_ai.utils.email.SMTP_HOST", "smtp.example.com")
    @patch("preloop_ai.utils.email.SMTP_PORT", 587)
...
class TestSendVerificationEmail:
    ...
    @patch("preloop_ai.utils.email.PRELOOP_URL", "https://app.test.com")
    ...
    @patch("preloop_ai.utils.email.send_email")
    @patch("preloop_ai.utils.email.APP_NAME", "Preloop AI")
...
class TestSendInvitationEmail:
    ...
    @patch("preloop_ai.utils.email.send_email")
    @patch("preloop_ai.utils.email.PRELOOP_URL", "https://custom.domain.com")
