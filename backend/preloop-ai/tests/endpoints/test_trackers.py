...
def mock_event_bus_connect():
    ...
    with patch(
        "preloop_sync.services.event_bus.EventBus.connect", new_callable=AsyncMock
    ) as mock_connect:
        yield mock_connect
...
@pytest.mark.asyncio
@patch("preloop_ai.api.endpoints.trackers.create_tracker_client")
...
@pytest.mark.asyncio
@patch("preloop_ai.api.endpoints.trackers.create_tracker_client")
@patch("preloop_ai.api.endpoints.trackers.event_bus_service.publish_task")
@patch("preloop_ai.api.endpoints.trackers.send_tracker_registered_email")
