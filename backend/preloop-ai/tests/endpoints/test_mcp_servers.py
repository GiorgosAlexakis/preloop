...
def mock_mcp_client():
    ...
    with patch("preloop_ai.services.mcp_client_pool.MCPClient") as mock_client_class:
...
def mock_tool_scan():
    ...
    with patch(
        "preloop_ai.api.endpoints.mcp_servers.scan_mcp_server_tools",
...
def test_schema_serialization_with_real_model(db_session, test_user):
    ...
    """
    from preloop_models.schemas.mcp_server import MCPServerResponse
