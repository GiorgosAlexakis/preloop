...
from preloop_ai.api.endpoints import comments
from preloop_ai.schemas.comment import CommentCreate


@pytest.mark.asyncio
@patch("preloop_ai.api.endpoints.comments.get_tracker_client")
...
@pytest.mark.asyncio
@pytest.mark.asyncio
@patch("preloop_ai.api.endpoints.comments.crud_comment.get_multi_by_issue")
async def test_search_comments_by_issue_id(mock_get_multi_by_issue):
    ...
    with patch(
        "preloop_ai.api.endpoints.comments.crud_tracker.get_for_account",
...
@pytest.mark.asyncio
@patch("preloop_ai.api.endpoints.comments.crud_comment.get_multi_by_author")
