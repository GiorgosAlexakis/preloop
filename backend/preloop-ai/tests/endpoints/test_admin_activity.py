...
from preloop_ai.api.endpoints.admin import router as admin_router
from preloop_ai.api.auth import get_current_active_user
from preloop_models.db.session import get_db_session
from preloop_models.models import Event, User
...
def mock_auth_and_permission(mock_superuser, mock_db_session):
    ...
    with patch("preloop_ai.api.endpoints.admin.require_permission") as mock_perm:
