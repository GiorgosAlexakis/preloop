...
class TestUnifiedWebSocket:
    ...
    @patch("preloop_ai.api.endpoints.websockets.handle_activity")
    @patch("preloop_ai.api.endpoints.websockets.session_manager")
    @patch("preloop_ai.api.endpoints.websockets.get_user_from_token_if_valid")
    @patch("preloop_ai.api.endpoints.websockets.manager")
