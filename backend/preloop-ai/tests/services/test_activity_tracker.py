...
from preloop_ai.services.activity_tracker import handle_activity
from preloop_ai.services.session_manager import WebSocketSession
from preloop_models.models import Event
...
def mock_event_bus():
    ...
    with patch("preloop_sync.services.event_bus.event_bus_service") as mock_bus:
        mock_nc = MagicMock()
...
async def test_track_page_view_creates_event(
    ...
    with patch("preloop_ai.services.activity_tracker.session_manager") as mock_sm:
