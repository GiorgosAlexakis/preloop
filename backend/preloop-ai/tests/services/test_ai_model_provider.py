...
from preloop_ai.services.ai_model_provider import (
...
class TestGetAvailableModelsForProvider:
    ...
    async def test_get_openai_models(self):
        ...
        with patch(
            "preloop_ai.services.ai_model_provider._get_openai_models"
        ) as mock_get:
    ...
    async def test_get_anthropic_models(self):
        ...
        with patch(
            "preloop_ai.services.ai_model_provider._get_anthropic_models"
        ) as mock_get:
    ...
    async def test_get_google_models(self):
        ...
        with patch(
            "preloop_ai.services.ai_model_provider._get_google_models"
        ) as mock_get:
    ...
    async def test_get_qwen_models(self):
        ...
        with patch(
            "preloop_ai.services.ai_model_provider._get_qwen_models"
        ) as mock_get:
    ...
    async def test_get_deepseek_models(self):
        ...
        with patch(
            "preloop_ai.services.ai_model_provider._get_deepseek_models"
        ) as mock_get:
