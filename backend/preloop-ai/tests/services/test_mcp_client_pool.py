...
from preloop_ai.services.mcp_client_pool import (
    MCPClient,
    MCPClientPool,
    get_mcp_client_pool,
)
...
class TestMCPClientConnect:
    ...
    async def test_connect_success_no_auth(self):
        ...
        with patch(
            "preloop_ai.services.mcp_client_pool.AsyncExitStack"
        ) as mock_exit_stack:
            ...
            with patch(
                "preloop_ai.services.mcp_client_pool.ClientSession",
                return_value=mock_session,
            ):
                with patch("preloop_ai.services.mcp_client_pool.streamablehttp_client"):
...
class TestMCPClientCallTool:
    ...
    async def test_call_tool_success_text_content(self):
        ...
        with (
            patch(
                "preloop_ai.services.mcp_client_pool.streamablehttp_client",
...
class TestMCPClientPoolGetClient:
    ...
    async def test_get_client_creates_new_client(self):
        ...
        with patch(
            "preloop_ai.services.mcp_client_pool.MCPClient", return_value=mock_client
        ):
    ...
    async def test_get_client_recreates_disconnected_client(self):
        ...
        with patch(
            "preloop_ai.services.mcp_client_pool.MCPClient", return_value=new_client
        ):
            client = await pool.get_client(
                server_id="server1",
                url="http://localhost:8001/mcp",
    ...
    async def test_get_client_with_auth_config(self):
        ...
        with patch(
            "preloop_ai.services.mcp_client_pool.MCPClient"
...
class TestGetMCPClientPool:
    ...
    def test_get_mcp_client_pool_creates_singleton(self):
        ...
        # Reset global
        import preloop_ai.services.mcp_client_pool as module
