...
1. Preloop AI server running on `http://localhost:8001`
2. External MCP server with a test tool registered and connected to Preloop AI
...
Then configure Preloop AI to connect to this server and run the tests.
