"""Tests for preloop_ai/api/common.py."""
...
@pytest.mark.asyncio
@patch("preloop_ai.api.common.crud_organization")
@patch("preloop_ai.api.common.crud_project")
@patch("preloop_ai.api.common.crud_tracker_scope_rule")
@patch("preloop_ai.api.common.create_tracker_client")
