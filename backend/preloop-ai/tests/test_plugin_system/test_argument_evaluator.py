...
from preloop_ai.plugins.builtin.argument_evaluator import ArgumentEvaluator
...
class TestArgumentEvaluatorPlugin:
    ...
    def test_plugin_registration(self):
        ...
        from preloop_ai.plugins.builtin import argument_evaluator
    ...
    def test_builtin_plugin_metadata(self):
        ...
        from preloop_ai.plugins.builtin.argument_evaluator import BuiltinPlugin
