...
from preloop_ai.tools.project.test_connection import verify_connection
from preloop_ai.schemas.tracker_models import TrackerConnection
...
@pytest.mark.asyncio
@patch("preloop_ai.tools.project.test_connection.get_db")
@patch("preloop_ai.tools.project.test_connection.CRUDOrganization")
@patch("preloop_ai.tools.project.test_connection.CRUDProject")
@patch("preloop_ai.tools.project.test_connection.create_tracker_client")
