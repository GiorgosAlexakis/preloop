...
from preloop_ai.schemas import tracker_models
from preloop_ai.tools.issue.search_issues import search_issues
...
@pytest.mark.asyncio
@patch("preloop_ai.tools.issue.search_issues.get_db")
@patch("preloop_ai.tools.issue.search_issues.CRUDOrganization")
@patch("preloop_ai.tools.issue.search_issues.CRUDProject")
@patch("preloop_ai.tools.issue.search_issues.create_tracker_client")
