...
from preloop_ai.tools.issue.create_issue import create_issue
...
@pytest.mark.asyncio
@patch("preloop_ai.tools.issue.create_issue.get_db")
@patch("preloop_ai.tools.issue.create_issue.CRUDOrganization")
@patch("preloop_ai.tools.issue.create_issue.CRUDProject")
@patch("preloop_ai.tools.issue.create_issue.create_tracker_client")
