...
Usage:
    python -m preloop_ai.scripts.cleanup_out_of_scope_issues --account-id <uuid>
    python -m preloop_ai.scripts.cleanup_out_of_scope_issues --tracker-id <uuid>
    python -m preloop_ai.scripts.cleanup_out_of_scope_issues --dry-run
"""
...
from preloop_models.models.issue import Issue, IssueEmbedding
from preloop_models.models.project import Project
from preloop_models.models.tracker import Tracker
from preloop_models.models.tracker_scope_rule import TrackerScopeRule
