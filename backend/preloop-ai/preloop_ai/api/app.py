...
from preloop_ai.api.auth import auth_router, get_current_active_user
from preloop_ai.api.endpoints import (
    account,
    approval_requests,
    comments,
    features,
...
from preloop_models.models.api_usage import ApiUsage
from preloop_sync.services.event_bus import connect_nats, close_nats  # NATS integration
...
async def lifespan(app: FastAPI):
    ...
    if os.getenv("TESTING") != "true":
        ...
        from preloop_ai.services.websocket_manager import manager, nats_consumer
        import asyncio
    ...
    if os.getenv("TESTING") != "true":
        from preloop_ai.services.execution_monitor import get_execution_monitor
    ...
    if os.getenv("TESTING") != "true":
        from preloop_ai.services.execution_recovery import get_recovery_service
    ...
    mcp_lifespan = None
    if os.getenv("TESTING") != "true":
        from preloop_ai.services.mcp_http import get_mcp_lifespan_manager
...
def create_app() -> FastAPI:
    ...
    async def serve_approval_page(request_id: str):
        ...
        approval_html_path = base_dir / "preloop_ai" / "templates" / "approval.html"
