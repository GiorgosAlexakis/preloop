...
from preloop_ai.api.common import (
    get_tracker_client,
    load_compliance_prompts_config,
)

from preloop_ai.api.endpoints.issues import (
    create_issue as api_create_issue,
)
from preloop_ai.api.endpoints.search import (
    perform_search,
    SearchResponse as ApiSearchResponse,
)
from preloop_ai.api.endpoints.issue_compliance import (
    _calculate_issue_compliance,
    get_compliance_improvement_suggestion as api_get_compliance_suggestion,
)
from preloop_ai.schemas.issue import IssueCreate
...
from preloop_ai.config import get_settings
...
async def add_comment(target: str, comment: str) -> "AddCommentResponse":
    ...
    """
    from preloop_ai.schemas.mcp import AddCommentResponse
...
async def get_pull_request(pull_request: str) -> "PullRequestResponse":
    ...
    """
    from preloop_ai.schemas.mcp import PullRequestResponse
...
async def get_merge_request(merge_request: str) -> "MergeRequestResponse":
    ...
    """
    from preloop_ai.schemas.mcp import MergeRequestResponse
...
async def update_pull_request(
    ...
    """
    from preloop_ai.schemas.mcp import UpdatePullRequestResponse
...
async def update_merge_request(
    ...
    """
    from preloop_ai.schemas.mcp import UpdateMergeRequestResponse
