...
preloop_ai/services/initialize_mcp.py to ensure consistency between REST API and MCP.
"""
...
from preloop_models.models.tool_configuration import ToolConfiguration
...
from preloop_ai.services.tool_approval_evaluator import evaluate_cel_expression
...
async def update_tool_approval_condition(
    ...
    Raises:
        HTTPException: If configuration not found or update fails
    """
    from preloop_models.crud import tool_approval_condition
    from preloop_models.models import ToolApprovalCondition
