...
from preloop_models.crud import crud_issue_duplicate

from preloop_ai.schemas.issue import IssueResponse, IssueUpdate
...
from preloop_models.models.user import User  # Import Account model
...
from preloop_ai.api.auth import get_current_active_user  # Import user dependency
from preloop_ai.config import get_settings, Settings
