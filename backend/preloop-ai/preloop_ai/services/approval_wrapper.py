...
def with_approval(tool_func: Callable) -> Callable:
    ...
    async def wrapper(*args, ctx: Optional[Context] = None, **kwargs) -> Any:
        ...
        try:
            ...
            from preloop_models.crud.tool_configuration import (
                get_tool_config_by_name_and_source_async,
            )
            from preloop_models.crud.approval_policy import get_approval_policy_async
            ...
            async with get_async_db_session() as db:
                ...
                try:
                    ...
                    while True:
                        ...
                        from preloop_models.crud.approval_request import (
