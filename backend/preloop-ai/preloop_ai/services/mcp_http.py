...
async def mcp_http_streaming_endpoint(
    ...
    if method == "tools/list":
        ...
        try:
            ...
            from preloop_ai.services.dynamic_mcp_server import UserContext
...
def setup_mcp_routes(app: FastAPI):
    ...
    from preloop_ai.services.initialize_mcp import initialize_mcp_with_tools
    from preloop_ai.services.dynamic_fastmcp_http import setup_dynamic_mcp_http
