...
preloop_ai/api/endpoints/tools.py to ensure consistency between MCP and REST API.
"""
...
from preloop_ai.services.approval_helper import require_approval
from preloop_ai.services.dynamic_fastmcp import (
    DynamicFastMCP,
...
def initialize_mcp_with_tools() -> DynamicFastMCP:
    ...
    from preloop_ai.api.endpoints import mcp as mcp_router
    ...
    async def get_issue(issue: str, ctx: Optional[Context] = None) -> str:
        ...
        from preloop_ai.services.dynamic_fastmcp_http import get_current_user_context
    ...
    # NOTE: Description must match BUILTIN_TOOLS in preloop_ai/api/endpoints/tools.py
    @mcp.tool()
    async def request_approval(
        ...
        from preloop_models.crud import crud_approval_policy
