...
class CodexAgent(ContainerAgentExecutor):
    ...
    async def _start_docker_container(self, execution_context: Dict[str, Any]) -> str:
        ...
        container_config = {
            ...
            "Labels": {
                "preloop_ai.flow_id": execution_context["flow_id"],
                "preloop_ai.execution_id": execution_id,
                "preloop_ai.agent_type": self.agent_type,
            },
            "HostConfig": {
    ...
    async def _prepare_environment(
        ...
        if account_id:
            try:
                ...
                from preloop_models.db.session import get_db_context
                from preloop_models.crud import tool_configuration as tool_config_crud
                from preloop_models.crud import approval_policy as approval_policy_crud
