...
class SpaceBridgeBearerAuthBackend(AuthenticationBackend):
    """
    Authentication backend that validates Bearer tokens using SpaceBridge's existing auth.
...
def setup_mcp_routes(app: FastAPI):
    ...
    from spacebridge.services.initialize_mcp import initialize_mcp_with_tools
    from spacebridge.services.dynamic_fastmcp_http import setup_dynamic_mcp_http
