...
def find_issue_duplicates(
    ...
    # Fetch only issue IDs first to keep memory usage low
    ...
    # Process issues in batches using the fetched IDs
    ...
    # Sort by similarity score in descending order before paginating
