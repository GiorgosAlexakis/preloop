...
from spacemodels.models import User
from spacebridge.api.auth.jwt import get_current_active_user, create_access_token
from spacemodels.crud import crud_audit_log
