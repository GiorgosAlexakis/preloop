...
from spacebridge.schemas.team import (
    TeamCreate,
    TeamDetailResponse,
    TeamListResponse,
    TeamMemberAdd,
...
from spacemodels.models.team import Team, TeamMembership
...
async def list_teams(
    ...
    from spacemodels.crud import crud_team_role
...
async def assign_team_role(
    ...
    # Verify role exists
    from spacemodels.crud import crud_role, crud_team_role
    ...
    from spacemodels.models.permission import TeamRole as TeamRoleModel
