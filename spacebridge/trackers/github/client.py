...
class GitHubClient(TrackerInterface):
    ...
    async def search_issues(
        ...
        sort_direction = "desc"
        if filter_params.sort_direction and filter_params.sort_direction.lower() in ["asc", "desc"]:
    ...
    async def get_issue(self, issue_id: str) -> Issue:
        ...
        # Get comments
        comments_path = f"/repos/{self.owner}/{self.repo}/issues/{issue_number}/comments"
