...
1. SpaceBridge server running on `http://localhost:8001`
2. External MCP server with a test tool registered and connected to SpaceBridge
3. Environment variables set:
   - `SPACEBRIDGE_TOKEN`: Your API key/token for authentication
...
**With pytest:**
```bash
export SPACEBRIDGE_TOKEN="your-api-key"
...
Then configure SpaceBridge to connect to this server and run the tests.
