...
class TestPerformSearch:
    ...
    @patch("spacebridge.api.endpoints.search.crud_issue_embedding")
    @patch("spacebridge.api.endpoints.search.crud_embedding_model")
    @patch("spacebridge.api.endpoints.search.crud_project")
    @patch("spacebridge.api.endpoints.search.crud_organization")
    async def test_similarity_search_success_with_issue(
        ...
        from spacebridge.api.endpoints.search import perform_search
