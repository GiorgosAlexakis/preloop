...
class TestHealthCheck:
    ...
    @patch("spacebridge.services.mcp_client_pool.get_mcp_client_pool")
    @patch("spacebridge.services.mcp_http.get_mcp_lifespan_manager")
    def test_health_check_all_healthy(
        ...
        from spacebridge.api.endpoints.health import health_check
