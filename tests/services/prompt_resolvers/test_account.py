...
from spacebridge.services.prompt_resolvers.account import AccountResolver
...
class TestAccountResolver:
    ...
    @pytest.mark.asyncio
    @patch("spacebridge.services.prompt_resolvers.account.crud_user")
    @patch("spacebridge.services.prompt_resolvers.account.crud_account")
