...
from spacebridge.services.session_manager import WebSocketSession
from spacemodels.models import Event
...
def mock_event_bus():
    ...
    with patch("spacesync.services.event_bus.event_bus_service") as mock_bus:
        mock_nc = MagicMock()
...
async def test_track_page_view_creates_event(
    ...
    with patch("spacebridge.services.activity_tracker.session_manager") as mock_sm:
