...
from spacebridge.services.execution_monitor import (
    ExecutionMonitor,
    get_execution_monitor,
)
from spacebridge.agents.base import AgentStatus
from spacemodels.models import FlowExecution, Flow
...
class TestCheckStaleExecutions:
    ...
    async def test_check_stale_executions_no_active(self, execution_monitor):
        ...
        with patch("spacebridge.services.execution_monitor.get_db") as mock_get_db:
            mock_db = MagicMock()
            mock_db.query.return_value.filter.return_value.all.return_value = []
...
class TestCheckExecution:
    ...
    async def test_check_execution_agent_executor_creation_fails(
        ...
        with patch(
            "spacebridge.services.execution_monitor.create_agent_executor",
...
class TestGetExecutionMonitor:
    ...
    def test_get_execution_monitor_creates_instance(self):
        ...
        import spacebridge.services.execution_monitor as em_module
    ...
    def test_get_execution_monitor_with_env_vars(self):
        ...
        with patch("spacebridge.services.execution_monitor.os.getenv") as mock_getenv:
