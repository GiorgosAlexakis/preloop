...
import pytest
from spacemodels.models import ApprovalPolicy, ApprovalRequest
...
class TestPostWebhookNotification:
    ...
    @patch("spacebridge.services.approval_service.httpx.AsyncClient")
...
class TestWaitForApproval:
    ...
    @patch("spacebridge.services.approval_service.asyncio.sleep")
