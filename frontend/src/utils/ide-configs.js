    ...
    return [
        {
            ...
            setup_instructions: 'Export your API key as an environment variable, then add the MCP server. Replace <code>YOUR_API_KEY_HERE</code> with your actual Preloop API key.',
...
claude mcp add --transport http preloop ${mcpUrl} --header "Authorization: Bearer $${envVarName}"`,
        },
        {
            ...
            setup_instructions: 'Install the MCP server using the Gemini CLI. Replace <code>YOUR_API_KEY_HERE</code> with your actual Preloop API key.',
            code: `export ${envVarName}="YOUR_API_KEY_HERE"
...
export ${envVarName}="YOUR_API_KEY_HERE"`,
        },
        {
            ...
            setup_instructions: 'Add this to your MCP settings. Replace <code>YOUR_API_KEY_HERE</code> with your actual Preloop API key.',
            code: `{
  "mcpServers": {
    "preloop": {
      "url": "${mcpUrl}",
