...
let ToolListItem = class ToolListItem extends LitElement {
    constructor() {
        super(...arguments);
        this.accessRules = [];
        this.policies = [];
    ...
    _openJustificationDialog() {
        this._justificationMode = this.tool.justification_mode || 'disabled';
        this._showJustificationDialog = true;
    }
    async _saveJustificationMode() {
        try {
            const { updateToolConfiguration, createToolConfiguration } = await import('../api');
            ...
            if (!configId) {
                const config = await createToolConfiguration({
                    ...
                    justification_mode: this._justificationMode === 'disabled'
                        ? null
    ...
    _renderRuleItem(rule, index) {
        ...
        const dragPosition = isDragOver && this._dragIndex !== null
      ...
      <div
        class="rule-item ${!rule.is_enabled ? 'disabled-rule' : ''} ${isDragging
            ...
            : ''} ${dragPosition}"
        draggable="true"
        @dragstart=${(e) => this._handleDragStart(index, e)}
        @dragover=${(e) => this._handleDragOver(index, e)}
        @dragleave=${() => this._handleDragLeave()}
        @drop=${(e) => this._handleDrop(index, e)}
    ...
    render() {
      ...
      >
        <div class="tool-header" @click=${this._toggleExpanded}>
          ...
          <div class="tool-toggle" @click=${(e) => e.stopPropagation()}>
            <sl-switch
              size="small"
      ...
      >
        ...
        <sl-radio-group
          ...
          @sl-change=${(e) => {
            this._justificationMode = e.target.value;
        }}
        >
...
], ToolListItem.prototype, "tool", void 0);
__decorate([
    property({ type: Array })
], ToolListItem.prototype, "accessRules", void 0);
__decorate([
    property({ type: Array })
], ToolListItem.prototype, "policies", void 0);
__decorate([
    property({ type: Object })
], ToolListItem.prototype, "features", void 0);
__decorate([
    property({ type: Boolean })
], ToolListItem.prototype, "expanded", void 0);
__decorate([
    state()
], ToolListItem.prototype, "_showRuleEditor", void 0);
__decorate([
    state()
], ToolListItem.prototype, "_editingRule", void 0);
__decorate([
    state()
], ToolListItem.prototype, "_showJustificationDialog", void 0);
__decorate([
    state()
], ToolListItem.prototype, "_justificationMode", void 0);
__decorate([
    state()
], ToolListItem.prototype, "_dragIndex", void 0);
__decorate([
    state()
], ToolListItem.prototype, "_dragOverIndex", void 0);
ToolListItem = __decorate([
