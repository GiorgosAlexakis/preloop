...
let LitApp = class LitApp extends LitElement {
        ...
        router.setRoutes([
            {
                ...
                action: (context, commands) => {
                    ...
                    const existingLandingView = routerOutlet?.querySelector('landing-view');
            ...
            { path: '/delete-account', component: 'delete-account-view' },
            {
                ...
                action: (context, commands) => {
                    ...
                    const view = commands.component('static-view');
                ...
                action: () => {
                    ...
                    if (accessToken) {
                        ...
                        if (params.get('setup_tracker')) {
                            sessionStorage.setItem('oauth_setup_tracker', params.get('setup_tracker'));
                        }
     ...
     */
    _autoStartGitHubAppInstall(token) {
