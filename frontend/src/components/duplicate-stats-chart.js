...
import { getProjectDuplicateStats, } from '../api';
Chart.register(...registerables);
let DuplicateStatsChart = class DuplicateStatsChart extends LitElement {
    constructor() {
        super(...arguments);
        this.projectIds = [];
    ...
    _createDiagonalPattern(chartCtx, color = 'black', backgroundColor = 'transparent') {
...
DuplicateStatsChart.styles = css `
    :host {
      display: block;
    }
...
__decorate([
    property({ type: Array })
], DuplicateStatsChart.prototype, "projectIds", void 0);
__decorate([
    property({ type: String })
], DuplicateStatsChart.prototype, "selectedStatus", void 0);
__decorate([
    property({ type: Number })
], DuplicateStatsChart.prototype, "similarityThreshold", void 0);
__decorate([
    property({ type: Boolean })
], DuplicateStatsChart.prototype, "interactive", void 0);
__decorate([
    state()
], DuplicateStatsChart.prototype, "_loading", void 0);
__decorate([
    state()
], DuplicateStatsChart.prototype, "_error", void 0);
__decorate([
    state()
], DuplicateStatsChart.prototype, "_statsData", void 0);
DuplicateStatsChart = __decorate([
    customElement('duplicate-stats-chart')
], DuplicateStatsChart);
export { DuplicateStatsChart };
