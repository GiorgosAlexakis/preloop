...
let AddTrackerModal = class AddTrackerModal extends LitElement {
    constructor() {
        super(...arguments);
        this.tracker = null;
        /**
        ...
        this.trackerUrl = 'https://api.github.com';
        this.trackerToken = '';
    ...
    connectedCallback() {
        ...
        if (this.tracker) {
            ...
            if (this.tracker.auth_type === 'github_app' &&
            ...
            this.selectedOrgs = this.tracker.scope_rules
                .filter((x) => x.rule_type == 'INCLUDE' && x.scope_type == 'ORGANIZATION')
                .reduce((acc, x) => {
            ...
            //   });
            // });
            this.includeFutureProjects = !this.tracker.scope_rules.filter((x) => x.rule_type == 'INCLUDE' && x.scope_type == 'PROJECT').length;
    ...
    renderStep1() {
      ...
      <sl-input
        ...
        @sl-input=${(e) => (this.trackerName = e.target.value)}
        required
        tabindex="0"
        autofocus
      ></sl-input>
      <sl-select
        ...
        @sl-change=${(e) => {
            ...
            const urlInput = this.shadowRoot?.querySelector('sl-input[name="url"]');
      ...
      <sl-input
        ...
        @sl-input=${(e) => (this.trackerUrl = e.target.value)}
      ...
      ${this.trackerType === 'jira'
            ...
            <sl-input
              ...
              @sl-input=${(e) => (this.trackerUsername = e.target.value)}
              required
            ></sl-input>
          `
            : ''}
            ...
            : this.trackerType === 'github' &&
              ...
              <details style="margin-bottom: 1rem;">
                ...
                <sl-input
                  ...
                  @sl-input=${(e) => (this.trackerToken = e.target.value)}
    ...
    renderStep2() {
      ...
      <div>
        <sl-checkbox
          ...
          @sl-change=${(e) => (this.includeFutureProjects = e.target.checked)}
        ...
        setTimeout(() => {
            this.shadowRoot
                ...
                if (item.selected && !isGitHubApp) {
                    item.dispatchEvent(new CustomEvent('sl-lazy-load', { bubbles: true }));
                }
            });
        }, 300);
        return html `
      ...
      >
        ${this.orgs.map((org) => html `
            <sl-tree-item
              ...
              @sl-lazy-load=${(e) => this.loadProjects(org.id, e.target)}
            >
              ${org.name}
              ${!isGitHubApp
            ? this.projects[org.id]?.map((proj) => html `
                      <sl-tree-item
                        value="${proj.id}"
    ...
    async testConnection() {
        ...
        try {
            ...
            if (this.authMethod === 'github_app' && this.githubInstallationId) {
                ...
                const response = await this._api.validateTrackerToken(this.trackerType, this.trackerToken, this.trackerUrl, this.trackerUsername, this.tracker?.id);
                if (!response.success) {
    ...
    async loadProjects(orgId, item) {
        ...
        try {
            const projects = await this._api.listProjectsForOrg(this.trackerType, this.trackerToken, orgId, this.trackerUrl, this.trackerUsername, this.tracker?.id);
            this.projects = { ...this.projects, [orgId]: projects };
            if (this.selectedOrgs[orgId]) {
                if (!this.includeFutureProjects) {
                    this.selectedProjects[orgId] = projects.reduce((acc, proj) => {
                        acc[proj.id] =
                            this.tracker?.scope_rules.filter((x) => x.rule_type == 'INCLUDE' &&
                                x.scope_type == 'PROJECT' &&
                                x.identifier == proj.id).length > 0;
                        return acc;
                    }, {});
                }
                else {
                    this.selectedProjects[orgId] = projects.reduce((acc, proj) => {
                        acc[proj.id] =
                            this.tracker?.scope_rules.filter((x) => x.rule_type == 'EXCLUDE' &&
                                x.scope_type == 'PROJECT' &&
                                x.identifier == proj.id).length == 0;
                        return acc;
                    }, {});
    ...
    async handleSave() {
        ...
        try {
            ...
            if (response?.warnings && response.warnings.length > 0) {
                ...
                this.dispatchEvent(new CustomEvent(this.tracker ? 'tracker-updated' : 'tracker-added', {
...
], AddTrackerModal.prototype, "tracker", void 0);
__decorate([
    property({ type: Boolean })
], AddTrackerModal.prototype, "opened", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "step", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "trackerName", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "trackerType", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "trackerUrl", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "trackerToken", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "trackerUsername", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "orgs", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "projects", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "selectedOrgs", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "selectedProjects", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "areAllProjectsSelected", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "includeFutureProjects", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "isLoading", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "errorMessage", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "warningMessages", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "githubAppConfigured", void 0);
__decorate([
    state()
], AddTrackerModal.prototype, "authMethod", void 0);
__decorate([
    property({ type: String })
], AddTrackerModal.prototype, "githubInstallationId", void 0);
__decorate([
    property({ type: String })
], AddTrackerModal.prototype, "githubTargetLogin", void 0);
AddTrackerModal = __decorate([
    customElement('add-tracker-modal')
], AddTrackerModal);
export { AddTrackerModal };
