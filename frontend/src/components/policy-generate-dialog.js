...
let PolicyGenerateDialog = class PolicyGenerateDialog extends LitElement {
    constructor() {
        super(...arguments);
        this.open = false;
        this._prompt = '';
          ...
          <sl-tab-panel name="prompt">
            <div class="form-group">
              <sl-textarea
                ...
                rows="5"
                .value=${this._prompt}
                @sl-input=${(e) => (this._prompt = e.target.value)}
            ...
            <div class="options-row">
              <sl-switch
                ...
                @sl-change=${(e) => (this._includeContext = e.target.checked)}
                ?disabled=${this._loading}
              >
          ...
          <sl-tab-panel name="audit">
            ...
            <div class="form-row">
              <sl-input
                ...
                @sl-input=${(e) => (this._startDate = e.target.value)}
                ?disabled=${this._loading}
              ></sl-input>
              <sl-input
                ...
                type="date"
                .value=${this._endDate}
                @sl-input=${(e) => (this._endDate = e.target.value)}
                ?disabled=${this._loading}
              ></sl-input>
            </div>
          </sl-tab-panel>
    ...
    _applyPolicy() {
        this.dispatchEvent(new CustomEvent('policy-apply', {
...
PolicyGenerateDialog.styles = css `
    :host {
      --dialog-width: 720px;
    }
...
], PolicyGenerateDialog.prototype, "open", void 0);
__decorate([
    state()
], PolicyGenerateDialog.prototype, "_prompt", void 0);
__decorate([
    state()
], PolicyGenerateDialog.prototype, "_includeContext", void 0);
__decorate([
    state()
], PolicyGenerateDialog.prototype, "_loading", void 0);
__decorate([
    state()
], PolicyGenerateDialog.prototype, "_error", void 0);
__decorate([
    state()
], PolicyGenerateDialog.prototype, "_generatedYaml", void 0);
__decorate([
    state()
], PolicyGenerateDialog.prototype, "_warnings", void 0);
__decorate([
    state()
], PolicyGenerateDialog.prototype, "_activeTab", void 0);
__decorate([
    state()
], PolicyGenerateDialog.prototype, "_startDate", void 0);
__decorate([
    state()
], PolicyGenerateDialog.prototype, "_endDate", void 0);
PolicyGenerateDialog = __decorate([
    customElement('policy-generate-dialog')
], PolicyGenerateDialog);
export { PolicyGenerateDialog };
