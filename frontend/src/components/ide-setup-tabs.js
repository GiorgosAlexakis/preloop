...
let IdeSetupTabs = class IdeSetupTabs extends LitElement {
    constructor() {
        super(...arguments);
        this.configs = [];
        this.defaultTab = 'claude-code';
        this.variant = 'default';
        this.globalPrerequisite = '';
        this.globalPrerequisiteLink = '';
        this.globalPrerequisiteLinkText = '';
        this.helpText = '';
        this._activeTab = '';
    }
    connectedCallback() {
          ...
          <div class="tab-content" role="tabpanel">
            ...
            ? html `
                  <div>
                    ...
                    <h5>Prerequisites</h5>
                    <ul>
                      ${activeConfig.prerequisites.map((prereq) => html `<li>${unsafeHTML(prereq)}</li>`)}
                    </ul>
                    <h5>Setup</h5>
...
__decorate([
    property({ type: Array })
], IdeSetupTabs.prototype, "configs", void 0);
__decorate([
    property({ type: String })
], IdeSetupTabs.prototype, "defaultTab", void 0);
__decorate([
    property({ type: String })
], IdeSetupTabs.prototype, "variant", void 0);
__decorate([
    property({ type: String })
], IdeSetupTabs.prototype, "globalPrerequisite", void 0);
__decorate([
    property({ type: String })
], IdeSetupTabs.prototype, "globalPrerequisiteLink", void 0);
__decorate([
    property({ type: String })
], IdeSetupTabs.prototype, "globalPrerequisiteLinkText", void 0);
__decorate([
    property({ type: String })
], IdeSetupTabs.prototype, "helpText", void 0);
__decorate([
    state()
], IdeSetupTabs.prototype, "_activeTab", void 0);
IdeSetupTabs = __decorate([
