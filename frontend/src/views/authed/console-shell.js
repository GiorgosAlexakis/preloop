...
//     h2 {}
//     `];
let ConsoleShell = class ConsoleShell extends LitElement {
    constructor() {
        super(...arguments);
        this.features = {};
    ...
    async connectedCallback() {
        ...
        window.addEventListener('show-upgrade-modal', () => {
            this._upgradeModal.show();
        });
        this._mediaQuery = window.matchMedia(`(max-width: ${SIDEBAR_BREAKPOINT}px)`);
     ...
     */
    _hasAnyAnalyticsFeature() {
        return !!(this.features.issue_compliance ||
            this.features.issue_duplicates ||
            this.features.issue_dependencies);
    }
    updated(changedProperties) {
        super.updated?.(changedProperties);
        if (changedProperties.has('_sidebarOpen') ||
...
__decorate([
    query('#upgrade-modal')
], ConsoleShell.prototype, "_upgradeModal", void 0);
__decorate([
    state()
], ConsoleShell.prototype, "features", void 0);
__decorate([
    state()
], ConsoleShell.prototype, "_featuresLoaded", void 0);
__decorate([
    state()
], ConsoleShell.prototype, "hasTrackers", void 0);
__decorate([
    state()
], ConsoleShell.prototype, "_sidebarOpen", void 0);
__decorate([
    state()
], ConsoleShell.prototype, "_isMobile", void 0);
ConsoleShell = __decorate([
