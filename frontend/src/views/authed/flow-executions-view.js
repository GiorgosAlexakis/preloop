...
let FlowExecutionsView = class FlowExecutionsView extends AuthedElement {
    constructor() {
        super(...arguments);
        this.executions = [];
    ...
    async loadExecutions() {
        ...
        this.executions = allExecutions.sort((a, b) => parseUTCDate(b.start_time).getTime() -
    ...
    handleWebSocketMessage(message) {
        ...
        if (message.type === 'status_update' && message.execution_id) {
            ...
            if (executionIndex >= 0) {
                ...
                this.executions = updated.sort((a, b) => parseUTCDate(b.start_time).getTime() -
                    parseUTCDate(a.start_time).getTime());
            }
            else {
          ...
          ${this.paginatedExecutions.length === 0
            ...
            : html `
                ...
                >
                  ...
                  ${Math.min(this.currentPage * this.pageSize, this.filteredExecutions.length)}
                ...
                <div class="table-wrapper">
                  <table>
                    ...
                    <tbody>
                      ${this.paginatedExecutions.map((exec) => html `
                          <tr>
                ...
                : '-'}
                            ...
                            <td>
                              <sl-button
                                size="small"
                                href=${router.urlForPath(`/console/flows/executions/${exec.id}`)}
                              >
...
__decorate([
    state()
], FlowExecutionsView.prototype, "executions", void 0);
__decorate([
    state()
], FlowExecutionsView.prototype, "wsConnected", void 0);
__decorate([
    state()
], FlowExecutionsView.prototype, "statusFilter", void 0);
__decorate([
    state()
], FlowExecutionsView.prototype, "currentPage", void 0);
__decorate([
    state()
], FlowExecutionsView.prototype, "pageSize", void 0);
FlowExecutionsView = __decorate([
    customElement('flow-executions-view')
], FlowExecutionsView);
export { FlowExecutionsView };
