...
import { getTeams, createTeam, updateTeam, deleteTeam, getTeamMembers, addTeamMember, removeTeamMember, getUsers, getRoles, getTeamRoles, assignTeamRole, removeTeamRole, getFeatures, } from '../../../api';
...
let TeamManagementView = class TeamManagementView extends LitElement {
    constructor() {
        super(...arguments);
        this.teams = [];
        this.users = [];
    ...
    async handleAddMember() {
        if (!this.selectedTeam || !this.selectedUserId)
            return;
        try {
    ...
    render() {
      ...
      <div class="teams-grid">
        ${repeat(this.teams, (team) => team.id, (team) => html `
            <sl-card>
            ...
            ? html `
                        <div class="team-roles">
                          <strong>Roles:</strong>
                          ${team.roles.map((role) => html `<sl-badge variant="primary"
                                >${role.name}</sl-badge
                              >`)}
                        </div>
                      `
      ...
      >
        <div class="form-grid">
          <sl-input
            ...
            @sl-input=${(e) => (this.newTeam.name = e.target.value)}
          ></sl-input>
          <sl-textarea
            label="Description"
            placeholder="Enter team description (optional)"
            value=${this.newTeam.description || ''}
            @sl-input=${(e) => (this.newTeam.description = e.target.value)}
          ></sl-textarea>
        </div>
        <sl-button
          slot="footer"
      ...
      >
        <div class="form-grid">
          <sl-input
            ...
            @sl-input=${(e) => (this.editTeam.name = e.target.value)}
          ></sl-input>
          <sl-textarea
            label="Description"
            value=${this.editTeam.description || ''}
            @sl-input=${(e) => (this.editTeam.description = e.target.value)}
          ></sl-textarea>
        </div>
        <sl-button
          slot="footer"
        ...
        <div class="add-member-section">
          ...
          <div class="add-member-form">
            <sl-select
              ...
              @sl-change=${(e) => (this.selectedUserId = e.target.value)}
              style="flex: 1;"
            >
              ${this.users
            .filter((u) => !this.teamMembers.some((m) => m.user_id === u.id))
            .map((user) => html `
...
__decorate([
    state()
], TeamManagementView.prototype, "teams", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "users", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "isLoading", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "error", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "isCreateModalOpen", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "isEditModalOpen", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "isMembersModalOpen", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "selectedTeam", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "teamMembers", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "newTeam", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "editTeam", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "selectedUserId", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "roles", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "isRoleModalOpen", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "teamRoles", void 0);
__decorate([
    state()
], TeamManagementView.prototype, "featureEnabled", void 0);
