...
import { listProjects, listOrganizations, searchIssues, getIssueCompliance, getCompliancePrompts, } from '../../api';
import consoleStyles from '../../styles/console-styles.css?inline';
let IssuesComplianceView = class IssuesComplianceView extends LitElement {
    constructor() {
        super(...arguments);
        this.INFO_ALERT_DISMISSED_KEY = 'preloop-issues-compliance-info-alert-dismissed';
        ...
        this._selectedCompliancePrompt = 'dor_compliance_v1';
        this._compliancePrompts = [];
        this._allProjects = [];
    ...
    async fetchIssues() {
        ...
        try {
            const project_ids = this._selectedProjectIds.length > 0
                ? this._selectedProjectIds
                : undefined;
    ...
    async fetchComplianceResults() {
        for (const issue of this._issues) {
            ...
            if (this._complianceResults[issueId] ||
                this._loadingCompliance[issueId]) {
                continue;
            }
            this._loadingCompliance = { ...this._loadingCompliance, [issueId]: true };
            try {
                const result = await getIssueCompliance(issueId, this._selectedCompliancePrompt);
                this._complianceResults = {
                    ...this._complianceResults,
                    [issueId]: result,
                };
                ...
                console.error(`Failed to fetch compliance result for issue ${issueId}:`, error);
            }
            finally {
                this._loadingCompliance = {
                    ...this._loadingCompliance,
    ...
    _openImproveComplianceModal(issue) {
        this._selectedIssueForCompliance = issue;
        this._isImproveComplianceModalOpen = true;
    }
    _handleComplianceModalClose() {
        this._isImproveComplianceModalOpen = false;
        this._selectedIssueForCompliance = null;
    }
    _handleComplianceUpdate(event) {
    ...
    _renderSearchBar() {
        const selectedPrompt = this._compliancePrompts.find((p) => p.id === this._selectedCompliancePrompt);
        return html `
      <div class="search-bar">
        <sl-input
          placeholder="Search issues by title, description, or ID..."
          .value=${this._searchQuery}
          @sl-input=${(e) => (this._searchQuery = e.target.value)}
          @keydown=${(e) => {
            if (e.key === 'Enter')
                this.handleSearch(e);
        }}
        ...
        <sl-dropdown>
          ...
          <sl-menu @sl-select=${this._handleComplianceTypeSelect}>
            ${this._compliancePrompts.map((prompt) => html `<sl-menu-item value=${prompt.id}
      ...
      <div class="table-container">
        <sl-card class="table-card">
          <table class="styled-table">
            ...
            const project = this._allProjects.find((p) => p.id === issue.project_id);
            ...
            return html `
                  ...
                  >
                    ...
                    <td>
                      ${when(this._loadingCompliance[issue.id], () => html `<sl-spinner></sl-spinner>`, () => {
                return complianceResult
                    ? html `
                                <sl-tooltip content=${complianceResult.reason}>
                                  <sl-badge
                                    variant=${getComplianceVariant(complianceResult.compliance_factor)}
                                    pill
                                  >
                ...
                complianceResult.compliance_factor === 1}
                        >
                          ...
                          <sl-menu
                            @sl-select=${(e) => this._handleMenuAction(e, issue)}
                          >
      ...
      <div class="column-layout wide">
        <div class="main-column">
          <div class="container">
            ...
            ${when(this._error, () => html `<div class="error">${this._error}</div>`)}
            ${when(!this._loading && !this._error && this._hasSearched, () => this.renderIssueTable())}
          </div>
        </div>
        <div class="side-column">
          <sl-card class="detail-view-card">
            ...
            const issue = this._issues.find((i) => i.id === this._expandedRowKey);
            if (issue) {
                const complianceResult = this._complianceResults[issue.id];
    ...
    _renderComplianceDetails(issue, complianceResult) {
        if (!complianceResult) {
            return nothing;
        }
        return html `
      <div class="review-section">
        ...
        ${when(complianceResult.compliance_factor === 0, () => html `
    ...
    _handleProjectFilterChange(e) {
        this._selectedProjectIds = e.detail.selectedProjectIds;
        this._currentPage = 1;
        this.fetchIssues();
    }
};
IssuesComplianceView.styles = [
...
__decorate([
    state()
], IssuesComplianceView.prototype, "_isInfoAlertOpen", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_searchQuery", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_hasSearched", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_issues", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_complianceResults", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_loadingCompliance", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_loading", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_error", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_expandedRowKey", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_isFilterModalOpen", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_isImproveComplianceModalOpen", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_selectedIssueForCompliance", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_selectedProjectIds", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_selectedStatus", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_selectedCompliancePrompt", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_compliancePrompts", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_allProjects", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_hasProjects", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_organizations", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_initialLoadComplete", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_updateSummary", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_currentPage", void 0);
__decorate([
    state()
], IssuesComplianceView.prototype, "_hasMorePages", void 0);
IssuesComplianceView = __decorate([
    customElement('issues-compliance-view')
], IssuesComplianceView);
export { IssuesComplianceView };
