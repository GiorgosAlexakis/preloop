...
import { listProjects, searchIssues, detectIssueDependencies, extendIssueDependencyScan, commitIssueDependencies, // Import the new function
 } from '../../api';
import consoleStyles from '../../styles/console-styles.css?inline';
import '../../components/pagination-controls.ts';
import { getStatusVariant } from '../../utils/verdict';
let IssuesDependenciesView = class IssuesDependenciesView extends LitElement {
    constructor() {
        super(...arguments);
        this._allProjects = [];
        ...
        this._committingDependencies = new Set();
    ...
    async fetchDependencies(issueIds) {
    ...
    async _expandScanForRow(issueId) {
        ...
        try {
            ...
            const existingPairs = new Set(newDependencyPairs.map((p) => `${p.source_issue_id}-${p.dependent_issue_id}`));
    ...
    async _handleCommitDependency(dependency) {
        ...
        try {
            ...
            if (response.dependencies.length > 0) {
                ...
                this._dependencies = this._dependencies.map((dep) => dep.source_issue_id === committedDep.source_issue_id &&
    ...
    async _handleCommitAllDependencies(dependencies, issueId) {
        ...
        try {
            ...
            if (response.dependencies.length > 0) {
                const committedKeys = new Set(response.dependencies.map((d) => `${d.source_issue_id}:${d.dependent_issue_id}`));
    ...
    _renderDependencyDetails(deps, issueId) {
      ...
      `;
        ...
        const uncommittedDependencies = allDependencies.filter((d) => !d.is_committed && !d.comes_from_tracker);
        ...
        <ul>
          ${items.map((d) => {
                ...
                const issueId = type === 'blocks' ? d.dependent_issue_id : d.source_issue_id;
              ...
              <li>
                ...
                ${when(!d.comes_from_tracker, () => html `<sl-button
                      size="small"
                      variant="neutral"
      ...
      <div class="detail-section dependency-details">
        <div class="dependencies-header">
          ...
          <sl-button
            ...
            @click="${() => this._handleCommitAllDependencies(uncommittedDependencies, issueId)}"
          >
            Commit All
          </sl-button>
        </div>
        ${when(deps.blocks.length > 0, () => html `
            <h5>Blocks</h5>
            ${renderList(deps.blocks, 'blocks')}
          `)}
        ${when(deps.blockedBy.length > 0, () => html `
            <h5>Blocked By</h5>
          ...
          <tbody>
            ...
            return html `
                ...
                >
                  ...
                  <td>
                    ...
                    <div class="dependency-tags">
                      ${when(this._loadingDependencies, () => html `<sl-spinner
                            style="font-size: 1em; vertical-align: middle;"
                          ></sl-spinner>`, () => html `
                          ${when(deps && deps.blocks.length > 0, () => html `
                              <sl-badge
                                pill
                                class="blocks-badge ${deps.blocks.some((d) => d.comes_from_tracker)
                ? 'from-tracker'
                : ''}"
                              >
                ...
                : ''}
                            ...
                            `)}
                          ${when(deps && deps.blockedBy.length > 0, () => html `
    ...
    render() {
      ...
      <div class="column-layout wide">
        <div class="main-column">
          <div class="container">
            ${when(this._selectedProjectId, () => this._renderIssueTable(), () => html `
          ...
          <sl-card class="detail-view-card">
            ...
            if (issue) {
                return html `<single-issue-detail-view .issue=${issue}>
                    <div slot="additional-info">
                      ${this._renderDependencyDetails(this._dependencyMap.get(issue.id), issue.id)}
                    </div>
                  </single-issue-detail-view>`;
            }
            else {
...
__decorate([
    state()
], IssuesDependenciesView.prototype, "_allProjects", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_selectedProjectId", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_issues", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_dependencies", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_dependencyMap", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_loadingIssues", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_loadingDependencies", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_error", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_isFilterModalOpen", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_selectedStatus", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_currentPage", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_hasMorePages", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_expandedRowKey", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_expandingIssueId", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_committingDependencies", void 0);
__decorate([
    state()
], IssuesDependenciesView.prototype, "_committingAllForIssue", void 0);
IssuesDependenciesView = __decorate([
    customElement('issues-dependencies-view')
], IssuesDependenciesView);
export { IssuesDependenciesView };
