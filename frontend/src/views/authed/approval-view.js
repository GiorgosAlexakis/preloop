...
let ApprovalView = class ApprovalView extends AuthedElement {
    constructor() {
        super(...arguments);
        this.requestId = '';
    ...
    connectWebSocket() {
        ...
        (message) => message.request_id === this.requestId);
    ...
    handleWebSocketMessage(message) {
        ...
        if (message.approval_request_id === this.requestId &&
    ...
    async loadApprovalRequest() {
        this.loading = true;
        this.error = null;
        try {
            const data = await this.fetchData(`/api/v1/approval-requests/${this.requestId}`);
            if (data) {
    ...
    async handleApprove() {
        ...
        this.actionResult = null;
        try {
            const response = await fetch(`/api/v1/approval-requests/${this.requestId}/approve`, {
                method: 'POST',
                headers: {
    ...
    async handleDecline() {
        ...
        this.actionResult = null;
        try {
            const response = await fetch(`/api/v1/approval-requests/${this.requestId}/decline`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
    ...
    render() {
      ...
      `;
        ...
        const displayStatus = this.approvalRequest.status === 'expired'
            ? 'TIMED OUT'
            ...
            ? html `
              ...
              <div class="comment-section">
                ...
                <sl-textarea
                  ...
                  rows="4"
                  .value=${this.comment}
                  @sl-input=${(e) => (this.comment = e.target.value)}
...
], ApprovalView.prototype, "requestId", void 0);
__decorate([
    state()
], ApprovalView.prototype, "approvalRequest", void 0);
__decorate([
    state()
], ApprovalView.prototype, "loading", void 0);
__decorate([
    state()
], ApprovalView.prototype, "error", void 0);
__decorate([
    state()
], ApprovalView.prototype, "comment", void 0);
__decorate([
    state()
], ApprovalView.prototype, "submitting", void 0);
__decorate([
    state()
], ApprovalView.prototype, "actionResult", void 0);
ApprovalView = __decorate([
