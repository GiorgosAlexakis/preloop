...
let ApprovalsView = class ApprovalsView extends AuthedElement {
    constructor() {
        super(...arguments);
    ...
    connectWebSocket() {
        this.unsubscribe = unifiedWebSocketManager.subscribe('approvals', (message) => this.handleWebSocketMessage(message));
    }
    handleWebSocketMessage(message) {
        ...
        if (message.type === 'approval_approved' ||
            ...
            const index = this.approvalRequests.findIndex((r) => r.id === message.approval_request_id);
            if (index !== -1) {
                const status = message.type.replace('approval_', '');
                this.approvalRequests = [
    ...
    async loadApprovalRequests() {
        ...
        try {
            ...
            if (data && Array.isArray(data)) {
                ...
                this.approvalRequests = data.sort((a, b) => new Date(b.requested_at).getTime() -
    ...
    calculateStats() {
        ...
        const avgResponseTimeMinutes = resolvedCount > 0 ? Math.round(totalResponseTime / resolvedCount) : 0;
    ...
    applyFilters() {
        ...
        if (this.searchQuery.trim()) {
            ...
            filtered = filtered.filter((r) => r.tool_name.toLowerCase().includes(query) ||
    ...
    handleToolFilterChange(e) {
        this.toolFilter = e.target.value;
        this.applyFilters();
    }
    handleSearchInput(e) {
        ...
        <div class="main-column">
          ...
          <div class="filters-row">
            ...
            >
              ...
              ${this.getUniqueTools().map((tool) => html `<sl-option value=${tool}>${tool}</sl-option>`)}
            </sl-select>
          ...
          ${this.filteredRequests.length === 0
            ...
            : html `
                <div class="approval-list">
                  ${this.filteredRequests.map((request) => html `
                ...
                : request.status}
                          ...
                          <div class="approval-meta">
                            <sl-tooltip
                              content=${this.formatFullDate(request.requested_at)}
                            >
                ...
                ? html `
                                  <sl-tooltip
                                    content="Resolved: ${this.formatFullDate(request.resolved_at)}"
                                  >
                                    <span class="approval-meta-item">
                ...
                ? html `
                                  <sl-tooltip
                                    content="Expires: ${this.formatFullDate(request.expires_at)}"
                                  >
                                    <span
                ...
                ? html `
                                ...
                                >
                                  "${request.agent_reasoning.substring(0, 100)}${request.agent_reasoning.length > 100
                    ? '...'
                    : ''}"
                                </div>
                              `
...
__decorate([
    state()
], ApprovalsView.prototype, "approvalRequests", void 0);
__decorate([
    state()
], ApprovalsView.prototype, "filteredRequests", void 0);
__decorate([
    state()
], ApprovalsView.prototype, "loading", void 0);
__decorate([
    state()
], ApprovalsView.prototype, "stats", void 0);
__decorate([
    state()
], ApprovalsView.prototype, "statusFilter", void 0);
__decorate([
    state()
], ApprovalsView.prototype, "toolFilter", void 0);
__decorate([
    state()
], ApprovalsView.prototype, "searchQuery", void 0);
ApprovalsView = __decorate([
