...
import { getAccountRuntimeSessionDetail, getAccountRuntimeSessions, getFlowExecutionGatewayEvents, updateAccountRuntimeSession, } from '../../api';
import consoleStyles from '../../styles/console-styles.css?inline';
import { unifiedWebSocketManager } from '../../services/unified-websocket-manager';
let RuntimeSessionsView = class RuntimeSessionsView extends LitElement {
    constructor() {
        super(...arguments);
        this.sessions = null;
        this.detail = null;
    ...
    async loadDetail() {
        ...
        try {
            this.detail = await getAccountRuntimeSessionDetail(this.selectedSessionId, this.buildDetailParams());
    ...
    async loadGatewayEvents(flowExecutionId) {
        if (!flowExecutionId) {
            this.gatewayEvents = [];
            this.gatewayEventsError = null;
            this.gatewayEventsLoading = false;
        ...
        try {
            ...
            this.gatewayEvents = (result.logs || []).filter((event) => event?.type === 'model_gateway_call');
        }
        catch (error) {
    ...
    handleSessionSourceTypeChange(event) {
        this.sessionSourceType = event.target.value;
    }
    ...
    handleInteractionQueryKeydown(event) {
        if (event.key !== 'Enter') {
            return;
        }
    ...
    getActivityBadgeVariant(status) {
        if (!status) {
            return 'neutral';
        }
    ...
    async endSelectedSession() {
        ...
        const confirmed = window.confirm(`End session "${this.getSessionDisplayName(session)}"?`);
        if (!confirmed) {
            return;
        }
      ...
      <div class="session-list">
        ${this.sessions.items.map((session) => html `
            ...
            >
              ...
              <div class="session-item-meta">
                Last activity
                ${this.formatDateTime(session.last_request_at ||
    ...
    renderGatewayEvent(event) {
      ...
      <sl-details class="gateway-event">
        <div slot="summary" class="gateway-event-summary">
          ${this.renderGatewayField('Time', this.formatDateTime(event.timestamp || null))}
          ${this.renderGatewayField('Model', payload.model_alias || payload.requested_model || 'Unknown model')}
          ${this.renderGatewayField('Provider', payload.provider_name ||
            payload.gateway_provider ||
            'Unknown provider')}
...
__decorate([
    state()
], RuntimeSessionsView.prototype, "sessions", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "detail", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "loading", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "detailLoading", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "error", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "selectedSessionId", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "selectedRange", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "startDate", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "endDate", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "searchQuery", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "sessionSourceType", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "status", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "interactionQuery", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "gatewaySearchQuery", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "actionLoading", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "gatewayEvents", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "gatewayEventsLoading", void 0);
__decorate([
    state()
], RuntimeSessionsView.prototype, "gatewayEventsError", void 0);
RuntimeSessionsView = __decorate([
    customElement('runtime-sessions-view')
], RuntimeSessionsView);
export { RuntimeSessionsView };
