...
let PublicPricingView = class PublicPricingView extends LitElement {
    constructor() {
        super(...arguments);
        this._interval = 'year';
    ...
    _handleSignUpRequest(e) {
        this._handleSignUp(e.detail.planId);
    }
    async _handleSignUp(planId) {
    ...
    _renderTable() {
        const maxFeatures = Math.max(...this._plans.map((p) => p.features.length));
        return html `
      <table class="pricing-table">
        <thead>
          <tr>
            ${this._plans.map((plan) => html `<th class="${plan.id === 'teams' ? 'popular' : ''}">
...
__decorate([
    state()
], PublicPricingView.prototype, "_interval", void 0);
__decorate([
    state()
], PublicPricingView.prototype, "_billingEnabled", void 0);
__decorate([
    state()
], PublicPricingView.prototype, "_oauthSigninEnabled", void 0);
PublicPricingView = __decorate([
    customElement('public-pricing-view')
], PublicPricingView);
export { PublicPricingView };
