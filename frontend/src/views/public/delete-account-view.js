...
let DeleteAccountView = class DeleteAccountView extends LitElement {
    constructor() {
        super(...arguments);
        this._email = '';
        this._username = '';
        ...
        <div class="form-container">
          ...
          <form @submit=${this._handleSubmit}>
            ...
            <sl-input
              ...
              @sl-input=${(e) => (this._username = e.target.value)}
            ></sl-input>
            ...
            <sl-textarea
              ...
              .value=${this._reason}
              @sl-input=${(e) => (this._reason = e.target.value)}
            ></sl-textarea>
...
__decorate([
    state()
], DeleteAccountView.prototype, "_email", void 0);
__decorate([
    state()
], DeleteAccountView.prototype, "_username", void 0);
__decorate([
    state()
], DeleteAccountView.prototype, "_accountId", void 0);
__decorate([
    state()
], DeleteAccountView.prototype, "_orgName", void 0);
__decorate([
    state()
], DeleteAccountView.prototype, "_reason", void 0);
__decorate([
    state()
], DeleteAccountView.prototype, "_submitting", void 0);
__decorate([
    state()
], DeleteAccountView.prototype, "_error", void 0);
__decorate([
    state()
], DeleteAccountView.prototype, "_success", void 0);
DeleteAccountView = __decorate([
