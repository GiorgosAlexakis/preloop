...
ResetPasswordView.styles = [formStyles];
__decorate([
    state()
], ResetPasswordView.prototype, "token", void 0);
__decorate([
    state()
], ResetPasswordView.prototype, "message", void 0);
__decorate([
    state()
], ResetPasswordView.prototype, "error", void 0);
