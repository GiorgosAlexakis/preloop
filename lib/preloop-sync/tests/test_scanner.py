...
class MockTrackerClient(TrackerClient):
    ...
    def __init__(self, tracker):
        ...
        self.tracker_type = tracker.tracker_type.lower() if hasattr(tracker.tracker_type, "value") else tracker.tracker_type.lower()
...
class TestTrackerClient(unittest.TestCase):
    ...
    def test_scan_issues(self, mock_crud_issue):
        ...
        self.client.client.transform_issue = MagicMock(return_value={
            "title": "Test Issue",
        ...
        mock_get_issues = MagicMock(return_value=[{"id": "1234"}])  # Return a sample issue
